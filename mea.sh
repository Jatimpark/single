...
#export sem=$( curl -s https://raw.githubusercontent.com/Jatimpark/coba/main/versions)
...
clear
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " ${z}│\E[42;1;37m        Welcome To Script Premium Wings          $NC${z}│$NC"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
...
echo -e "           ${CYAN}ALL XRAY    ${NC}  $y=$NC $vma$NC" "$a"
echo -e "       ───────────────────────────────────────────────${NC}" | lolcat 
echo -e "                ${KIRI} \E[42;1;37mJANGAN LUPA MENCURI ${NC} ${KANAN}"
echo -e " ${z}╭════════════════╮╭══════════════════╮╭════════════════════╮${NC}"
...
echo -e " ${z}│$NC [${r}06${NC}]${CYAN} CEK ALXRAY $NC  ${z}│$NC [${r}13${NC}]${CYAN} VPS INFO$NC    ${z} │$NC [${r}20${NC}]${CYAN} INS. UDP    $NC${z}│$NC"
echo -e " ${z}│$NC [${r}07${NC}]${CYAN} UPDATE SCRIPT$NC${z}│$NC [${r}14${NC}]${CYAN} CANGE BNR$NC   ${z} │$NC [${r}21${NC}]${CYAN} CLEAR CACHE $NC${z}│$NC"
echo -e " "
echo -e " ${z}│$NC [${r}22${NC}]${CYAN} SETTING MENU$NC"
echo -e " ${z}│$NC [${r}23${NC}]${CYAN} RESTART BANNER $NC "
echo -e " ${z}│$NC [${r}24${NC}]${CYAN} KLUAR AREA $NC "
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
echo -e "${z} ╭══════════════════════════════════════════════════════════╮${NC}"
...
echo -e " "
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " ${z}│\E[42;1;37mVersion   = NGAPAIN BELI KLU ADA YG FREE ${NC}"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
echo " "
...
21) clear ; clearlog ;;
22) clear ; menu-set ;;
23) clear ; /etc/init.d/dropbear restart ;;
24) clear ; exit ;;
0) clear ; menu ;;
00) exit ;;
*) echo -e "" ; echo "JANCOK" ; sleep 1 ; menu ;;
esac
