...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/Arya-Blitar22/sct/main/ipmini >/dev/null 2>&1
...
LIST=$(curl -sS https://raw.githubusercontent.com/Arya-Blitar22/sct/main/license/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/Arya-Blitar22/sct/main/license/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/Arya-Blitar22/sct/main/license/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/Arya-Blitar22/sct/main/license/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/Arya-Blitar22/sct/main/license/key | grep $kode | awk '{print $6}')
cd
if [[ $kode == "aryapro" ]]; then
MYIP=$(curl -sS ipv4.icanhazip.com)
rm -rf /etc/github
mkdir /etc/github
curl -s https://pastebin.com/raw/t3aaqcej > /etc/github/api
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.com/Arya-Blitar22/sct/main/license/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
res1() {
wget https://raw.githubusercontent.com/Arya-Blitar22/sct/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/Arya-Blitar22/sct/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
...
echo -e  "${BIBlue}│                 \033[1;37mARYAPRO                  ${BIBlue}│${NC}"
echo -e  "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo " "
...
clear
wget https://raw.githubusercontent.com/Arya-Blitar22/sct/main/install/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
#res8() {
#wget https://raw.githubusercontent.com/Arya-Blitar22/sct/main/slowdns/installsl.sh && chmod +x installsl.sh && sudo apt update && sudo apt install dos2unix && dos2unix installsl.sh && ./installsl.sh
#clear
#}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Arya-Blitar22/sct/ipmini | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/AryaBlitar"},{"text":"CHANNEL","url":"https://t.me/AryaBlitar"}]]}'
